...
@BComponentComposer
export class ActionManagerBase extends BBusinessComponent {
  static propTypes = {
    ...
    if (this.props.formHeader) {
      headerDiv = (
        <div style={{ backgroundColor: Utils.formHeaderTransactionTypesColor(this.props.formHeaderTransactionTypes, this.props) }}>
          ...
          >
            {BLocalization.stringUpperCase(this.props.formHeader)}
          </BFlexPanel>
        </div>
      );
    }
  ...
  sortActionList(actionList) {
    actionList.sort(function (a, b) {
      ...
      var nameA = BLocalization.stringUpperCase(a.name);
      var nameB = BLocalization.stringUpperCase(b.name);
      if (nameA > nameB) {
        return 1;
      }
      if (nameA < nameB) {
    ...
    for (let i = 0; i < actionList.length; i++) {
      ...
      let returnObject = (
        <BMenuItem
          ...
          primaryText={BLocalization.stringUpperCase(action.name)}
          menuItems={subItems}
      ...
      this.props.visibleHelpButton &&
        actionMenuList.push(
          <BMenuItem
            ...
            isAddedDrawer={true}
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'Help'))}
      ...
      this.props.visibleInfoButton &&
        actionMenuList.push(
          <BMenuItem
            ...
            primaryText={BLocalization.stringUpperCase(this.getMessage('DynamicFormGenerator', 'ResourceInfo'))}
            isAddedDrawer={Utils.isMobile(this.props)}
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
      ...
      if (this.props.visibleOptionsButton) {
        ...
        optionMenus.push(
          <BMenuItem
            ...
            isAddedDrawer={true}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'ControlShowMenuPath'))}
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'AddToFavorites'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'RankThisScreen'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'MessageHistory'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'MyNotes'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'EnterDemandOrSuggestion'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        optionMenus.push(
          <BMenuItem
            ...
            style={{ direction: !this.props.context.localization.isRightToLeft ? 'ltr' : 'rtl' }}
            primaryTextPadding={'0px 16px 0px 16px'}
            primaryText={BLocalization.stringUpperCase(this.getMessage('BOA', 'OpenINC'))}
            isAddedDrawer={Utils.isMobile(this.props)}
        ...
        actionMenuList.push(
          <BMenuItem
            ...
            primaryText={BLocalization.stringUpperCase(this.getMessage('BusinessComponents', 'Options'))}
            isAddedDrawer={Utils.isMobile(this.props)}
          />
        );
      }
