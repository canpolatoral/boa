...
export class BCardTestGenerator {
  ...
  onActionClick(command: any) {
    switch (command.commandName) {
      case 'GetInfo': {
        BFormManager.showStatusMessage('zeynep - snack-bar');
        break;
      }
      case 'Save': {
        BFormManager.showStatusMessage('zeynep - snack-bar', 'Button');
        break;
      }
      case 'Clean': {
        BFormManager.showStatusMessage('zeynep - snack-bar', 'Button2', this._onclick);
        break;
      }
      default:
        break;
  ...
  onButtonClicked() {
    BFormManager.showStatusMessage('actionButton');
  }
  generate(context) {
