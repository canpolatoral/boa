...
import sampleData from '../../ui/treeview/b-treeview/data/sampleData';  
import styled from 'styled-components';
import Paper from '@material-ui/core/Paper';
import {Tabs, Tab } from '@material-ui/core';
import Typography from '@material-ui/core/Typography';
import doc from '../../ui/treeview/b-treeview/docs/content.json';
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-xs-6">
                ...
                <BResourceBrowser canMultipleSelect={true} actionListVisibility={false} context={context} />
                {/* <TextField
                  id="dataSize"
                  label="Generate random data"
                  placeholder="10000"
                  value={self.state.dataSize}
                  onChange={this.handleOnTextChange('dataSize')}
                  margin="normal"
                />
                <Button
                  variant="raised"
                  color="primary"
                  onClick={e => {
                    let newData = generate(2500);
                    this.self.setState({ data: newData });
                  }}
                >
                  Generate
                </Button> */}
