...
var textInputField = require('./TextInputEntryFactory'),
  ...
  parameterComponentFactory = require('./ParameterComponentFactory'),
  dynamicPropertiesField = require('./DynamicPropertiesFactory');
...
EntryFactory.parameterComponentFactory = function (options) {
  return parameterComponentFactory(options);
};

EntryFactory.dynamicPropertiesField = function (options, entryFactory) {
  return dynamicPropertiesField(options, entryFactory);
};
