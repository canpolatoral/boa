...
var is = require('../../../../bpmn-js/util/ModelUtil').is,
  isAny = require('../../../../bpmn-js/features/modeling/util/ModelingUtil').isAny,
  getBusinessObject = require('../../../../bpmn-js/util/ModelUtil').getBusinessObject;
...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  var newElement = function(type) {
    return function(element, extensionElements) {
