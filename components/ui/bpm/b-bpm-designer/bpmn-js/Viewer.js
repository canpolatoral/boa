...
import TranslateModule from '../diagram-js/i18n/translate';
import SelectionModule from '../diagram-js/features/selection';
import OveraysModule from '../diagram-js/features/overlays';
...
export default function Viewer(options) {
  ...
  this._context = this._createContext(options);
...
Viewer.prototype.getContext = function() {
...
Viewer.prototype._createContext = function(options) {
  var context = assign({}, this._context, options.context);
  return context;
};

Viewer.prototype._context = {};
