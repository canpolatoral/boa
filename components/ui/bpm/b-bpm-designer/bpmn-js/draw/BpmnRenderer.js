...
import TextUtil from '../../diagram-js/util/Text';
...
import {
  createLine
} from '../../diagram-js/util/RenderUtil';
...
import {
  ...
  transform,
  translate
} from '../../diagram-js/util/SvgTransformUtil';
...
export default function BpmnRenderer(
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:SequenceFlow': function (parentGfx, element) {
      ...
      var colorData = config.data.color;

      var fill = colorData ? colorData.fillColor : getFillColor(element),
        stroke = colorData ? colorData.strokeColor : getStrokeColor(element);
