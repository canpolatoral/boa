...
export class BDataGrid extends BComponent {
  ...
  getFormatedColumnValue(column, dataItem) {
    ...
    if (column.type == 'date' || column.type == 'number') {
      ...
      let formatedValue;
      if (column.type == 'date') {
        formatedValue = BLocalization.formatDateTime(dataItem[column.key], defaultDateFormat);
      }
      else if (column.type == 'number') {
        formatedValue = BLocalization.formatCurrency(dataItem[column.key], defaultNumberFormat);
      }
