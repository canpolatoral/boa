...
import Resizable, { Direction } from './resizer';
...
@BComponentComposer
export class BResizableBeta extends BComponent {
  ...
  updateSize(size: { width: number, height: number }) {
    this.resizable.updateSize({ width: size.width || this.props.default.width, height: size.height || this.props.default.height });
  }
