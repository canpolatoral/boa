...
@BComponentComposer
@withStyles(styles)
export class BMenuItem extends BComponent {
  ...
  render() {
    ...
    return (
      <MenuItem
        ...
        value={this.props.value}>
        {leftIcon ? (
          <ListItemIcon style={this.props.leftIconStyle ? this.props.leftIconStyle : leftIcon.props.style} 
            className={this.props.classes.leftIconClass} >
            {leftIcon}
          </ListItemIcon>
        ) : null}
        {/* <ListItemText classes={{ primary: this.props.classes.primary }}
                 style={{textAlign: this.props.context.localization.isRightToLeft ? 'right' : 'left'}}
                 inset primary={this.props.primaryText}
                 inset secondary={this.props.secondaryText}/> */}
        ...
        {menuItems}
        {rightIcon ? (
          <ListItemIcon style={this.props.rightIconStyle ? this.props.rightIconStyle : rightIcon.props.style} 
