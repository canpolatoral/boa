...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(jQuery) {(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1000), __webpack_require__(1164), __webpack_require__(1166), __webpack_require__(1116), __webpack_require__(1022), __webpack_require__(1170), __webpack_require__(1171), __webpack_require__(1172), __webpack_require__(1013), __webpack_require__(1169), __webpack_require__(1173), __webpack_require__(1115), __webpack_require__(1174), __webpack_require__(1175), __webpack_require__(1176), __webpack_require__(1177), __webpack_require__(1178), __webpack_require__(1161) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	...
	(function($, undefined) {
	    var kendo = window.kendo,
	        ...
	        SELECTCOLUMNHEADERTMPL = kendo.template(
	    ...
	    var Grid = kendo.ui.DataBoundWidget.extend({
	        ...
	        cancelRow: function(notify) {
	            ...
	            if (container) {
	                ...
	                if (that._isVirtualEditable() && isScrolledToBottom) {
	                    //do not rely on the async scroll event to update the view
	                    //as model canceling removes unsynced items, which changes the virtual scrollbar dimensions
	        ...
	        _restoreVirtualView: function() {
	            ...
	            that._virtualPage(skip, take, function() {
	                ...
	                if (virtualScrollable._isScrolledToBottom()) {
	                    //do not rely on the async scroll event to update the view and virtual scrollbar position
	                    virtualScrollable.scrollToBottom();
	                } else {
	        ...
	        _canFocusEditable: function() {
	            var that = this;
	            return ((that._isVirtualIncellEditable() || that._isVirtualInlineEditable()) &&
	                    that.virtualScrollable._isElementVisible(that._editContainer));
	        },
	        ...
	        _dirtyCellTemplate: function(field, paramName) {
	            ...
	            if (field && paramName) {
	                dirtyField = field.indexOf("[") >= 0 ? kendo.expr(field, paramName + ".dirtyFields") : paramName + ".dirtyFields['" + field + "']";
