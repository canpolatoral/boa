...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1436), __webpack_require__(1452) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	    "use strict";
	        ...
	        toFixed: function toFixed(value, decimals) {
	            ...
	            if (pos >= 0) {
	                ...
	                if (decpart.length < decimals) {
	                    // because (2.1825).toFixed(20) is '2.18250000000000010658' :-\
	                    // also, (0.3).toFixed(20) is '0.29999999999999998890'.
