...
import Overlay from '@material-ui/core/internal/Overlay';
import RenderToLayer from '@material-ui/core/internal/RenderToLayer';
...
class DialogInline extends Component {
  ...
  positionDialog() {
    ...
    // mesutg: dialog form için düzenleme
    // dialogContent.style.height = '';
    if (dialogContent.style.height != '100%') dialogContent.style.height = '';

    let dialogWindowHeight = dialogWindow.offsetHeight;

    // mesutg: dialog form için düzenleme
    // if (dialogContent.style.height.indexOf('%') > 0) {
    //   dialogWindowHeight = dialogContent.style.height.replace('%', '') * clientHeight / 100;
    // }
    ...
    // mesutg: dialog form için düzenleme
    dialogWindow.style.height = 'inherit';
    dialogWindow.style.width = 'inherit';
    ...
    if (autoDetectWindowHeight || autoScrollBodyContent) {
      ...
      if (dialogContent.style.height != '100%') dialogContent.style.maxHeight = `${maxDialogContentHeight}px`;
    }
  }
