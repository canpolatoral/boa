...
export function getDatePickerStyle(context, datePickerStyle:any) {

  const boaPalette=context.theme.boaPalette;
  const palette=context.theme.palette;
  let datePicker= {
    calWorkDay: datePickerStyle != undefined && datePickerStyle.processingDayColor != undefined ? datePickerStyle.processingDayColor : boaPalette.calWorkDay,
    calWeekend: datePickerStyle != undefined && datePickerStyle.weekendColor != undefined ? datePickerStyle.weekendColor : boaPalette.calWeekend,
    calHoliday: datePickerStyle != undefined && datePickerStyle.holidayColor != undefined ? datePickerStyle.holidayColor : boaPalette.calHoliday,
    ...
    textColor:datePickerStyle != undefined && datePickerStyle.textColor != undefined ? datePickerStyle.textColor : palette.alternateTextColor,
