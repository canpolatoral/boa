...
class RenderedMenu extends BComponent {
  ...
  getColoredTextBySearchText(searchText, child) {
    ...
    if (searchText && searchText.length > 0 && BComponent.Localization.stringLowerCase(label).includes(BComponent.Localization.stringLowerCase(searchText))) {
      let spanArray = [];
      while (BComponent.Localization.stringLowerCase(label).includes(BComponent.Localization.stringLowerCase(searchText))) {
        let index = BComponent.Localization.stringLowerCase(label).indexOf(BComponent.Localization.stringLowerCase(searchText));
        if (index > 0) {
